-- ═══════════════════════════════════════════
-- QuantumOS Charminar Mehfil — Neon Schema
-- v1.2.0 | Migrated from Supabase
-- Run: psql $DATABASE_URL -f neon/migration.sql
-- ═══════════════════════════════════════════

-- Enable extensions (Neon supports uuid-ossp, pgcrypto)
