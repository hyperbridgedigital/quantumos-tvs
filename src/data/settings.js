export const settingsConfig = {
  ...
  '📲 OTP & Verification': [
    ...
    { key:'OTP_SMS_PROVIDER', label:'SMS Provider', value:'MSG91', type:'select', options:['MSG91','2Factor.in','Kaleyra','Gupshup SMS','Netcore Cloud SMS','Textlocal','Fast2SMS','Twilio','Vonage (Nexmo)','Sinch','Plivo','AWS SNS','Firebase Phone Auth','Amazon SNS'] },
    { key:'OTP_SMS_FALLBACK', label:'SMS Fallback', value:'2Factor.in', type:'select', options:['None','MSG91','2Factor.in','Kaleyra','Gupshup SMS','Netcore Cloud SMS','Textlocal','Fast2SMS','Twilio','Vonage (Nexmo)','Sinch','Plivo','AWS SNS','Firebase Phone Auth','Amazon SNS'] },
    { key:'OTP_WHATSAPP', label:'WhatsApp OTP Enabled', value:'true', type:'toggle' },
    { key:'OTP_WA_PROVIDER', label:'WhatsApp BSP', value:'Meta Cloud API', type:'select', options:['Meta Cloud API (Direct)','Gupshup','WATI','Twilio WhatsApp','Interakt','AiSensy','360dialog','DoubleTick','Infobip WhatsApp','UltraMsg','Green API','CallMeBot','Maytapi'] },
    { key:'OTP_EMAIL', label:'Email OTP Enabled', value:'true', type:'toggle' },
    { key:'OTP_EMAIL_PROVIDER', label:'Email Provider', value:'SendGrid (Twilio)', type:'select', options:['SendGrid (Twilio)','Netcore Email','AWS SES','Mailgun','Postmark','Resend','Brevo (Sendinblue)','MailerSend','SMTP2GO','Zoho ZeptoMail','Amazon SES'] },
