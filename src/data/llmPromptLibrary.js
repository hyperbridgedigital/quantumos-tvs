...
export const llmPromptLibrary = [
  ...
  { id:'LP06', name:'Area Landing Content', category:'seo', prompt:'Write SEO-optimized content for the {{area}} landing page. Include local landmarks, delivery info, and why TheValueStore is the best choice in {{area}}.', approved:false, guardrails:['no_false_claims','include_nap'] },
];
