...
export const cmsDb = {
  ...
  instagramFeed: {
    active: true,
    title: 'TheValueStore on Instagram',
    subtitle: 'Gaming gear, setups & more — follow @logitechg for inspiration. (Test posts: Logitech.)',
    maxItems: 8,
    posts: [
      { id: 'IG01', url: 'https://www.instagram.com/logitech/reel/DGd7Q9JvSlc/', mediaType: 'video', caption: 'You built your setup, detail by detail.', active: true, order: 1 },
      { id: 'IG02', url: 'https://www.instagram.com/logitechg/reel/C5iCBlqITKB/', mediaType: 'video', caption: 'PRO X 60 LIGHTSPEED Keyboard – esports-grade compact design.', active: true, order: 2 },
      { id: 'IG03', url: 'https://www.instagram.com/reel/DPjnuPSDMJ4/', mediaType: 'video', caption: 'Logitech G gaming gear review.', active: true, order: 3 },
      { id: 'IG04', url: 'https://www.instagram.com/techcravers/p/DAFnHx_txA7/', mediaType: 'image', caption: 'Logitech G bundle – keyboards, mice, mics.', active: true, order: 4 },
    ],
  },
