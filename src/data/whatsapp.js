export const waTemplates = [
  ...
  { id:'TPL03', name:'welcome_offer', status:'approved', category:'MARKETING', lang:'en', body:'Welcome to TheValueStore {{1}}! 🎉 Get {{2}}% off on your first order with code: {{3}}', params:3, sent:3200 },
  ...
  { id:'TPL05', name:'referral_invite', status:'approved', category:'MARKETING', lang:'en', body:'{{1}} invited you to TheValueStore! Use code {{2}} for ₹{{3}} off your first order 🎮', params:3, sent:5600 },
